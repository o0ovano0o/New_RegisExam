...
router.post('/api/admin/admin',validateUser, validateAdminAPI, async(req, res) => {
    try {
...
router.delete('/api/admin/admin/:id',validateUser, validateAdminAPI, async(req, res) => {
    try {
        const { id } = req.params;
...
router.get('/api/admin/admins',validateUser, validateAdminAPI, async(req, res) => {
    try {
