                    ...
                    <div class="col-sm-4">
                        <div class="page-header float-left">
                            <div class="page-title">
                                <h1><strong>TRÍ TUỆ NHÂN TẠO</strong></h1>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="danh-sach-AI-duoc-thi"><button type="button" class="btn btn-success btn-lg">Được Thi</button></a>
                                <a href="danh-sach-AI-cam-thi"><button type="button" class="btn btn-danger btn-lg">Cấm Thi</button></a>
